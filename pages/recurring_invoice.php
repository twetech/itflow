...
if (isset($_GET['recurring_id'])) {
    ...
    require_once "/var/www/nestogy.io/includes/modals/recurring_invoice_edit_modal.php";

    require_once "/var/www/nestogy.io/includes/modals/recurring_invoice_note_modal.php";
