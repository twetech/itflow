    ...
    <div class="col-9">
        ...
        <?php if ($ticket_responses > 0) { ?>
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <!-- Ticket replies -->
                    <table id="responsive" class="table responsive table-hover">
                        <thead>
                            <tr>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control trumbowyg" id="response" name="ticket_reply" placeholder="Type a response"></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <?php } else { ?>
                                    <div class="form-group">
                                        <textarea id="trumbowyg" class="form-control" name="ticket_reply"
