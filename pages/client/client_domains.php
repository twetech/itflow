    ...
    <div class="card">
        <div class="card-header py-2">
            ...
            <div class="card-tools">
                <div class="btn-group">
                    <button type="button" class="btn btn-label-primary loadModalContentBtn" data-bs-toggle="modal" data-bs-target="#dynamicModal" data-modal-file="client_domain_add_modal.php?client_id=<?php echo $client_id; ?>"><i class="fas fa-plus mr-2"></i>New Domain</button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown dropleft text-center">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" onclick="populateDomainEditModal(<?php echo $client_id, ",", $domain_id ?>)" data-bs-target="#editDomainModal">
...
<?php
require_once "/var/www/nestogy.io/includes/modals/client_domain_edit_modal.php";

require_once "/var/www/nestogy.io/includes/modals/client_domain_add_modal.php";

require_once "/var/www/nestogy.io/includes/modals/client_domain_export_modal.php";
?>
