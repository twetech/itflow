...
<table class="datatables-basic table border-top">
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        require "/var/www/nestogy.io/includes/modals/vendor_edit_modal.php";
...
<?php
require_once "/var/www/nestogy.io/includes/modals/vendor_add_modal.php";

require_once "/var/www/nestogy.io/includes/modals/vendor_add_from_template_modal.php";

require_once "/var/www/nestogy.io/includes/modals/client_vendor_export_modal.php";
