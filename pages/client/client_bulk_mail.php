    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button id="bulkActionButton" hidden class="btn btn-label-primary" type="submit" form='bulkActions' name="send_bulk_mail_now">
                    ...
                    <div class="col">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="mail_from_name" placeholder="From Name"
                                value="<?= nullable_htmlentities($config_mail_from_name); ?>" required>
                        </div>
                                ...
                                <table id=responsive class="responsive table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="client_contact_details.php?client_id=<?= $client_id; ?>&contact_id=<?= $contact_id; ?>"
                                                    target="_blank">
                                                    <?= $contact_name; ?>
                                                </a>
                                            </td>
