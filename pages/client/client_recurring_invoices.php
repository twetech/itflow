...
<div class="card">
    <div class="card-header py-2">
        ...
        <div class="card-tools">
            <div class="btn-group">
                <button type="button" class="btn btn-soft-primary loadModalContentBtn" data-bs-toggle="modal" data-bs-target="#dynamicModal" data-modal-file="recurring_add_modal.php?client_id=<?php echo $client_id; ?>"><i class="fas fa-plus mr-2"></i>New Recurring</button>
                ...
                <div class="col-md-8">
                    <div class="float-right">
                        <div class="btn-group float-right">
                            <a href="client_invoices.php?client_id=<?php echo $client_id; ?>" class="btn btn-soft-primary"><i class="fa fa-fw fa-file-invoice mr-2"></i>Back to Invoices</a>
                        </div>
                    </div>
                </div>
...
require_once "/var/www/develop.twe.tech/includes/modals/client_recurring_export_modal.php";
