                            ...
                            <div class="dropdown dropleft text-center">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <?php if ($session_user_role == 3 && $location_primary == 0) { ?>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger confirm-link" href="/post/?archive_location=<?php echo $location_id; ?>">
                                            <i class="fas fa-fw fa-archive mr-2"></i>Archive
                                        </a>
                                        <?php if ($config_destructive_deletes_enable) { ?>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger text-bold confirm-link" href="/post/?delete_location=<?php echo $location_id; ?>">
