                ...
                <tbody>
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        if (empty($login_uri)) {
                            ...
                            $login_uri_display = "$login_uri<button class='btn btn-label-secondary clipboardjs' type='button' data-clipboard-text='$login_uri'><i class='far fa-copy text-secondary'></i></button>";
                        }
...
require_once "/var/www/nestogy.io/includes/modals/client_login_add_modal.php";

require_once "/var/www/nestogy.io/includes/modals/share_modal.php";

require_once "/var/www/nestogy.io/includes/modals/client_login_import_modal.php";

require_once "/var/www/nestogy.io/includes/modals/client_login_export_modal.php";
