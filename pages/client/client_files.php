            ...
            <div class="col-md-3 border-right mb-3">
                ...
                <ul class="nav nav-pills flex-column bg-light">
                    ...
                    while ($row = mysqli_fetch_array($sql_folders)) {
                        ...
                        <?php
                        require "/var/www/nestogy.io/includes/modals/folder_rename_modal.php";


                    }
                    ?>
                </ul>
                <?php require_once "/var/www/nestogy.io/includes/modals/folder_create_modal.php";
 ?>
            </div>
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        <?php
                        require "/var/www/nestogy.io/includes/modals/client_file_view_modal.php";
