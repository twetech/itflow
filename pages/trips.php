...
<table class="datatables-basic table border-top">
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        require "/var/www/nestogy.io/includes/modals/trip_copy_modal.php";

                        require "/var/www/nestogy.io/includes/modals/trip_edit_modal.php";

                        require "/var/www/nestogy.io/includes/modals/trip_export_modal.php";
