...
$sql = "
    SELECT 
        ...
        (invoice_items.item_price * invoice_items.item_quantity * (1 + IFNULL(taxes.tax_percent, 0) / 100)) AS item_total_with_tax,
    ...
    ORDER BY taxes.tax_name, clients.client_name, invoices.invoice_id, payments.payment_id, invoice_items.item_id
";
...
if (mysqli_num_rows($result) > 0) {
    echo "<h1>Detailed Breakdown for All Taxes in " . date('F Y', strtotime($year . '-' . $month . '-01')) . "</h1>";
