    ...
    <div class="card">
        <div class="card-header py-2">
            ...
            <div class="card-tools">
                <button type="button" class="btn btn-soft-primary loadModalContentBtn" data-bs-toggle="modal" data-bs-target="#dynamicModal" data-modal-file="product_add_modal.php"><i class="fas fa-plus mr-2"></i>New Product</button>
            </div>
        </div>
