...
<div class="card">
    ...
    <div class="card-body">
        <form action="/post.php" method="post" autocomplete="off">
            ...
            <button type="submit" name="edit_ai_settings" class="btn btn-soft-primary text-bold"><i class="fa fa-check mr-2"></i>Save</button>
        ...
        <div class="mt-5">
            ...
            <button id="rewordButton" class="btn btn-soft-primary"><i class="fas fa-fw fa-robot mr-2"></i>Reword</button>
