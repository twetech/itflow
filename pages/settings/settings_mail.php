    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/post.php" method="post" autocomplete="off">
                ...
                <button type="submit" name="edit_mail_smtp_settings" class="btn btn-label-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/post.php" method="post" autocomplete="off">
                ...
                <button type="submit" name="edit_mail_imap_settings" class="btn btn-label-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/post.php" method="post" autocomplete="off">
                ...
                <button type="submit" name="edit_mail_from_settings" class="btn btn-label-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
