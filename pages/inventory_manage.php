                        ...
                        while ($row = mysqli_fetch_array($sql)) {
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="inventory_location_manage.php?inventory_location_id=<?php echo $inventory_location_id; ?>" class="btn btn-soft-primary btn-sm"><i class="fas fa-fw fa-edit"></i></a>
                                    </div>
                                </td>
