...
?>
    ...
    <ol class="breadcrumb d-print-none">
        ...
        <li class="breadcrumb-item">
            <a href="client_quotes.php?client_id=<?= $client_id; ?>"><?= $client_name; ?></a>
        </li>
    ...
    <div class="card">
                ...
                <div class="col-8">
                    <?php if ($quote_status == 'Draft') { ?>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php } ?>
                            <a class="dropdown-item" href="/post.php?mark_quote_sent=<?= $quote_id; ?>">
                    ...
                    <?php if ($quote_status == 'Sent' || $quote_status == 'Viewed') { ?>
                        <a class="btn btn-label-primary" href="/post.php?accept_quote=<?= $quote_id; ?>">
                            <i class="fas fa-thumbs-up mr-2"></i>Accept
                        </a>
                        <a class="btn btn-default" href="/post.php?decline_quote=<?= $quote_id; ?>">
                            <i class="fas fa-thumbs-down mr-2"></i>Decline
                        </a>
                    <?php } ?>

                    <?php if ($quote_status == 'Accepted') { ?>
                        <a class="btn btn-label-primary" href="#" data-bs-toggle="modal" data-bs-target="#addQuoteToInvoiceModal<?= $quote_id; ?>">
                ...
                <div class="col-4">
                    <div class="dropdown dropleft text-center float-right">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="#" onclick="pdfMake.createPdf(docDefinition).download('<?= strtoAZaz09(html_entity_decode("$quote_date-$company_name-$client_name-Quote-$quote_prefix$quote_number")); ?>');">
                            ...
                            <?php } ?>
                            <a class="dropdown-item" target="_blank" href="portal/guest_view_quote.php?quote_id=<?= "$quote_id&url_key=$quote_url_key"; ?>">
        ...
        <div class="card-body">
            ...
            <div class="row mb-4">
                ...
                <div class="col-10">
                    <div class="ribbon-wrapper">
                        <div class="ribbon bg-<?= $quote_badge_color; ?>">
                            <?= $quote_status; ?>
                        </div>
                    </div>
                    <h3 class="text-right mt-5"><strong>Quote</strong><br><small class="text-secondary"><?= "$quote_prefix$quote_number"; ?></small></h3>
                </div>
            </div>
            <div class="row mb-4">
                <div class="col">
                                ...
                                <tbody>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <form action="/post.php" method="post">
                                                                <input type="hidden" name="item_quote_id" value="<?= $quote_id; ?>">
                                                                <input type="hidden" name="item_id" value="<?= $item_id; ?>">
                                                                <input type="hidden" name="item_order" value="<?= $item_order; ?>">
                                                                <button class="dropdown-item" type="submit" name="update_quote_item_order" value="up" <?= $up_hidden; ?>><i class="fa fa-fw fa-arrow-up mr-2"></i>Move Up</button>
                                                                <?php if ($up_hidden == "" && $down_hidden == "") {
                                                                    echo '<div class="dropdown-divider"></div>';
                                                                } ?>
                                                                <button class="dropdown-item" type="submit" name="update_quote_item_order" value="down" <?= $down_hidden; ?>><i class="fa fa-fw fa-arrow-down mr-2"></i>Move Down</button>
                                                            </form>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editItemModal<?= $item_id; ?>">
                                                                <i class="fa fa-fw fa-edit mr-2"></i>Edit
                                                            </a>
                                                            <div class="dropdown-divider"></div>
                                                            <a class="dropdown-item text-danger confirm-link" href="/post.php?delete_quote_item=<?= $item_id; ?>">
                                    ...
                                    <tr class="d-print-none" <?php if ($quote_status == "Invoiced" || $quote_status == "Accepted" || $quote_status == "Declined") {
                                        ...
                                        <form action="/post.php" method="post" autocomplete="off">
                                            ...
                                            <td>
                                                <input type="text" class="form-control" inputmode="numeric" pattern="-?[0-9]*\.?[0-9]{0,2}" id="price" style="text-align: right;" name="price" placeholder="Price (<?= $quote_currency_code; ?>)">
                                            </td>
                                            <td>
            ...
            <div class="d-none d-print-block text-center"><?= nl2br(nullable_htmlentities($config_quote_footer)); ?></div>
        </div>
    </div>
            ...
            // Header
            {
                columns: [
                    ...
                    [{
                        ...
                        text: <?= json_encode("$quote_prefix$quote_number") ?>,
                        style: 'invoiceNumber',
                        width: '*'
                    }, ],
                ],
