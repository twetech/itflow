            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <?php if ($quote_status == 'Sent' || $quote_status == 'Viewed') { ?>
                        <a class="btn btn-label-primary" href="/post.php?accept_quote=<?php echo $quote_id; ?>">
                    ...
                    <?php if ($quote_status == 'Accepted') { ?>
                        <a class="btn btn-label-primary" href="#" data-bs-toggle="modal" data-bs-target="#addQuoteToInvoiceModal<?php echo $quote_id; ?>">
                ...
                <div class="col-4">
                    <div class="dropdown dropleft text-center float-right">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <?php } ?>
                            <a class="dropdown-item" target="_blank" href="portal/guest_view_quote.php?quote_id=<?php echo "$quote_id&url_key=$quote_url_key"; ?>">
...
<?php
    ...
    require_once "/var/www/nestogy.io/includes/modals/quote_to_invoice_modal.php";

    require_once "/var/www/nestogy.io/includes/modals/quote_copy_modal.php";

    require_once "/var/www/nestogy.io/includes/modals/quote_note_modal.php";
}
