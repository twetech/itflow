...
<table class="datatables-basic table border-top">
                    ...
                    while ($row = mysqli_fetch_array($sql)) {
                        ...
                        require "/var/www/nestogy.io/includes/modals/admin_inventory_location_edit_modal.php";
...
<?php
require_once "/var/www/nestogy.io/includes/modals/admin_inventory_location_add_modal.php";
