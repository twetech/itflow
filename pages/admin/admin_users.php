...
<div class="card">
    <div class="card-header py-2">
        ...
        <div class="card-tools">
            <div class="btn-group">
                <button type="button" class="btn btn-label-primary loadModalContentBtn" data-bs-toggle="modal" data-bs-target="#dynamicModal" data-modal-file="admin_user_add_modal.php">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="dropdown dropleft text-center">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item loadModalContentBtn" href="#" data-bs-toggle="modal" data-bs-target="#dynamicModal" data-modal-file="admin_user_edit_modal.php?user_id=<?= $user_id; ?>">
