...
<html lang="en" class="light-style layout-navbar-fixed layout-wide" dir="ltr" data-theme="theme-default" data-assets-path="/includes/assets/" data-template="front-pages-no-customizer">

<head>
    <meta charset="utf-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />

    <title>ITFlow-NG | ERP for MSP</title>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="/includes/assets/vendor/css/rtl/core.css" />
    ...
    <link rel="stylesheet" href="/includes/assets/vendor/libs/swiper/swiper.css" />
    ...
    <script src="/includes/assets/js/front-config.js"></script>
</head>

<body>
    <script src="/includes/assets/vendor/js/dropdown-hover.js"></script>
    <script src="/includes/assets/vendor/js/mega-dropdown.js"></script>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-lg-4 d-none d-lg-block">
                                        <div class="bg-body nav-img-col p-2">
                                            <img src="/includes/assets/img/front-pages/misc/nav-item-col-img.png" alt="nav item col image" class="w-100" />
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="landingHero" class="section-py landing-hero position-relative">
                ...
                <div class="container">
                    <div class="hero-text-box text-center">
                        <h1 class="text-primary hero-title display-4 fw-bold">One dashboard to manage your whole business</h1>
                            ...
                            <div class="card-header">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        ...
                                        <sub class="h6 text-muted mb-0 ms-1">You read that right</sub>
                                    </div>
                        ...
                        <div class="card border border-primary shadow-lg">
                            <div class="card-header">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="price-monthly h1 text-primary fw-bold mb-0">$7.25</span>
                                        <sub class="h6 text-muted mb-0 ms-1">Per Month Per Client</sub>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <h5>
                                            <span class="badge badge-center rounded-pill bg-primary p-0 me-2"><i class="bx bx-check bx-xs"></i></span>
                                            Up to <b>150</b> Clients and Leads
                                        </h5>
                                    </li>
                                </ul>
                                <div class="d-grid mt-4 pt-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center">
                                        <span class="price-monthly h1 text-primary fw-bold mb-0">$17.25</span>
                                        <sub class="h6 text-muted mb-0 ms-1">Per Month Per Client</sub>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <h5>
                                            <span class="badge badge-center rounded-pill bg-label-primary p-0 me-2"><i class="bx bx-check bx-xs"></i></span>
                                            Quickbooks® and Sage100® Integration
                                        </h5>
                                    </li>
                                    <li>
                                        <h5>
                                    ...
                                    <li>
                                        <h5>
                                            <span class="badge badge-center rounded-pill bg-label-primary p-0 me-2"><i class="bx bx-check bx-xs"></i></span>
                                            <b>Unlimited</b> Clients and Leads
                                        </h5>
                                    </li>
                                </ul>
                                <div class="d-grid mt-4 pt-3">
                            ...
                            <div class="card accordion-item">
                                <h2 class="accordion-header" id="headingFour">
                                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#accordionFour" aria-expanded="false" aria-controls="accordionFour">
                                        What makes ITFlow-NG Different?
                                    </button>
                                </h2>
    ...
    <footer class="landing-footer bg-body footer-text">
        <div class="footer-top position-relative overflow-hidden z-1">
            <img src="/includes/assets/img/front-pages/backgrounds/footer-bg-light.png" alt="footer bg" class="footer-bg banner-bg-img z-n1" data-app-light-img="front-pages/backgrounds/footer-bg-light.png" data-app-dark-img="front-pages/backgrounds/footer-bg-dark.png" />
            <div class="container">
                <div class="row gx-0 gy-4 g-md-5">
                    <div class="col-lg-5">
                        <a href="https://twe.tech" class="app-brand-link mb-4">
                            <span class="app-brand-logo demo">
                                <svg width="25" viewBox="0 0 25 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <defs>
                                        <path d="M13.7918663,0.358365126 L3.39788168,7.44174259 C0.566865006,9.69408886 -0.379795268,12.4788597 0.557900856,15.7960551 C0.68998853,16.2305145 1.09562888,17.7872135 3.12357076,19.2293357 C3.8146334,19.7207684 5.32369333,20.3834223 7.65075054,21.2172976 L7.59773219,21.2525164 L2.63468769,24.5493413 C0.445452254,26.3002124 0.0884951797,28.5083815 1.56381646,31.1738486 C2.83770406,32.8170431 5.20850219,33.2640127 7.09180128,32.5391577 C8.347334,32.0559211 11.4559176,30.0011079 16.4175519,26.3747182 C18.0338572,24.4997857 18.6973423,22.4544883 18.4080071,20.2388261 C17.963753,17.5346866 16.1776345,15.5799961 13.0496516,14.3747546 L10.9194936,13.4715819 L18.6192054,7.984237 L13.7918663,0.358365126 Z" id="path-1"></path>
                            ...
                            <span class="app-brand-text demo footer-link fw-bold ms-2 ps-1">ITFlow-NG</span>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <a href="javascript:void(0);" class="d-block footer-link mb-3 pb-2"><img src="/includes/assets/img/front-pages/landing-page/apple-icon.png" alt="apple icon" /></a>
                        <a href="javascript:void(0);" class="d-block footer-link"><img src="/includes/assets/img/front-pages/landing-page/google-play-icon.png" alt="google play icon" /></a>
                    </div>
                    -->
                </div>
            </div>
        ...
        <div class="footer-bottom py-3">
            <div class="container d-flex flex-wrap justify-content-between flex-md-row flex-column text-center text-md-start">
                <div class="mb-2 mb-md-0">
                    ...
                    <a href="https://themeselection.com" target="_blank" class="fw-medium text-white footer-link">TWE Technologies,</a>
                    <span class="footer-text"> Made with ❤️ by MSPs, for MSPs.</span>
                </div>
                <div>
                    <a href="https://github.com/themeselection" class="footer-link me-3" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/github-light.png" alt="github icon" data-app-light-img="front-pages/icons/github-light.png" data-app-dark-img="front-pages/icons/github-dark.png" />
                    </a>
                    <a href="https://www.facebook.com/ThemeSelections/" class="footer-link me-3" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/facebook-light.png" alt="facebook icon" data-app-light-img="front-pages/icons/facebook-light.png" data-app-dark-img="front-pages/icons/facebook-dark.png" />
                    </a>
                    <a href="https://twitter.com/Theme_Selection" class="footer-link me-3" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/twitter-light.png" alt="twitter icon" data-app-light-img="front-pages/icons/twitter-light.png" data-app-dark-img="front-pages/icons/twitter-dark.png" />
                    </a>
                    <a href="https://www.instagram.com/themeselection/" class="footer-link" target="_blank">
                        <img src="/includes/assets/img/front-pages/icons/instagram-light.png" alt="google icon" data-app-light-img="front-pages/icons/instagram-light.png" data-app-dark-img="front-pages/icons/instagram-dark.png" />
                    </a>
                </div>
            </div>
        </div>
    ...
    <!-- Vendors JS -->
    <script src="/includes/assets/vendor/libs/nouislider/nouislider.js"></script>
    <script src="/includes/assets/vendor/libs/swiper/swiper.js"></script>

    <!-- Main JS -->
    <script src="/includes/assets/js/front-main.js"></script>

    <!-- Page JS -->
    <script src="/includes/assets/js/front-page-landing.js"></script>
</body>
