    <div class="container-xxl d-flex h-100">
        <ul class="menu-inner">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="/pages/clients.php" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-briefcase"></i>
                            <div data-i18n="Clients">Clients</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/tickets.php" class="menu-link">
                            <i class="menu-icon bx bx-first-aid"></i>
                            <div data-i18n="Tickets">Tickets</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/calendar_events.php" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="/pages/quotes.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-comment-dollar"></i>
                            <div data-i18n="Quotes">Quotes</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/invoices.php" class="menu-link">
            ...
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="/pages/payments.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-credit-card"></i>
                            <div data-i18n="Payments">Payments</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/vendors.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-building"></i>
                            <div data-i18n="Vendors">Vendors</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/expenses.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-money-check-alt"></i>
                            <div data-i18n="Expenses">Expenses</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/accounts.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-money-bill-wave"></i>
                            <div data-i18n="Accounts">Accounts</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/transfers.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-exchange-alt"></i>
                            <div data-i18n="Transfers">Transfers</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/budget.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-money-check"></i>
                            <div data-i18n="Budgets">Budgets</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="/pages/trips.php" class="menu-link">
                            <i class="menu-icon tf-icons fa fa-plane"></i>
                ...
                <ul class="menu-sub">
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="Front Pages">Technical</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-store"></i>
                            <div data-i18n="Back Pages">Back Pages</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
                                <a href="../back-pages/landing-page.html" class="menu-link" target="_blank">
                                    <div data-i18n="Landing">Landing</div>
                                </a>
                            </li>
                        </ul>
