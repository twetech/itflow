...
<div class="modal" id="editItemModal<?= $item_id; ?>" tabindex="-1">
    ...
    <div class="modal-content bg-dark">
      ...
      <form action="/post.php" method="post" autocomplete="off">
        ...
        <div class="modal-body bg-white">
          ...
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="name" value="<?= $item_name; ?>" placeholder="Enter item name" required>
            </div>
          </div>
            ...
            <div class="col-sm">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" inputmode="numeric" pattern="[0-9]*\.?[0-9]{0,2}" name="qty" value="<?= number_format($item_quantity,2); ?>" placeholder="0.00" required>
                </div>
              </div>
            ...
            <div class="col-sm">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" inputmode="numeric" pattern="-?[0-9]*\.?[0-9]{0,2}" name="price" value="<?= number_format($item_price, 2, '.', ''); ?>" placeholder="0.00" required>
                </div>
              </div>
        ...
        <div class="modal-footer bg-white">
          <button type="submit" name="edit_item" class="btn btn-label-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
