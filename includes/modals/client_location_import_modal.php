		...
		<div class="modal-content bg-dark">
			...
			<form action="/post.php" method="post" enctype="multipart/form-data" autocomplete="off">
				...
				<div class="modal-body bg-white">
					...
					<hr>
					<div>Download: <a class="text-bold" href="/post.php?download_client_locations_csv_template=<?= $client_id; ?>">sample csv template</a></div>
				</div>
				<div class="modal-footer bg-white">
					<button type="submit" name="import_client_locations_csv" class="btn btn-label-primary text-bold"><i class="fa fa-upload mr-2"></i>Import</button>
