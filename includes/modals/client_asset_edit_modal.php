...
<div class="modal" id="editAssetModal<?= $asset_id; ?>" tabindex="-1">
            ...
            <form action="/post.php" method="post" autocomplete="off">
                ...
                <input type="hidden" name="client_id" value="<?= $client_id; ?>">
                    ...
                    <ul class="nav nav-pills  mb-3">
                        <li class="nav-item">
                            <a class="nav-link active" role="tab" data-bs-toggle="tab" href="#pills-details<?= $asset_id; ?>">Details</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#pills-network<?= $asset_id; ?>">Network</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#pills-assignment<?= $asset_id; ?>">Assignment</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#pills-purchase<?= $asset_id; ?>">Purchase</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" role="tab" data-bs-toggle="tab" href="#pills-notes<?= $asset_id; ?>">Notes</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="pills-details<?= $asset_id; ?>">
                            ...
                            if ($asset_type !== 'virtual') { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="serial" placeholder="Serial number" value="<?= $asset_serial; ?>">
                                    </div>
                                </div>
                            <?php } ?>
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="pills-network<?= $asset_id; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="ip" value="<?= $asset_ip; ?>" placeholder="192.168.10.250" data-inputmask="'alias': 'ip'" data-mask>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="nat_ip" value="<?= $asset_nat_ip; ?>" placeholder="10.52.4.55" data-inputmask="'alias': 'ip'" data-mask>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="mac" value="<?= $asset_mac; ?>" placeholder="MAC Address" data-inputmask="'alias': 'mac'" data-mask>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="uri" placeholder="URI http:// ftp:// ssh: etc" value="<?= $asset_uri; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="uri_2" placeholder="URI http:// ftp:// ssh: etc" value="<?= $asset_uri_2; ?>">
                                </div>
                            </div>

                        </div>

                        <div class="tab-pane fade" role="tabpanel" id="pills-assignment<?= $asset_id; ?>">
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="pills-purchase<?= $asset_id; ?>">
                        ...
                        <div class="tab-pane fade" role="tabpanel" id="pills-notes<?= $asset_id; ?>">
