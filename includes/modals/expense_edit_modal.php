...
<div class="modal" id="editExpenseModal<?= $expense_id; ?>" tabindex="-1">
        ...
        <div class="modal-content bg-dark">
            ...
            <form action="/post.php" method="post" enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control select2" id='select2' name="client">
                                        ...
                                        while ($row = mysqli_fetch_array($sql_clients)) {
                                            ...
                                            ?>
                                            <option <?php if ($expense_client_id == $client_id_select) { echo "selected"; } ?> value="<?= $client_id_select; ?>"><?= $client_name_select; ?></option>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="edit_expense" class="btn btn-label-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
