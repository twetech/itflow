            ...
            <form action="/post.php" method="post" autocomplete="off">
                ...
                <div class="modal-body bg-white">
                    ...
                    <div class="form-group">
                        <textarea id=trumbowyg class="form-control" name="ticket_reply"><?php echo nullable_htmlentities($ticket_reply); ?></textarea>
                    </div>
                ...
                <div class="modal-footer bg-white">
                    <button type="submit" name="edit_ticket_reply" class="btn btn-soft-primary text-bold"><i class="fa fa-check mr-2"></i>Save</button>
