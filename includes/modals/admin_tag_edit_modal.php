...
<div class="modal" id="editTagModal<?= $tag_id; ?>" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content bg-dark">
      <div class="modal-header">
        <h5 class="modal-title"><i class="fas fa-fw fa-tag mr-2"></i>Editing tag: <strong><?= $tag_name; ?></strong></h5>
        ...
        <input type="hidden" name="tag_id" value="<?= $tag_id; ?>">
          <div class="form-group">
            ...
            <div class="input-group">
              ...
              <input type="text" class="form-control" name="name" value="<?= $tag_name; ?>" required>
            </div>
          </div>
