...
if ($session_company_reseller) {
    $menuItems = [
        [
            'title' => ucwords($localization['companies']), // 'Companies
            'icon' => 'bx bx-building',
            'link' => '/pages/reseller/companies.php'
        ],
        [
            'title' => ucwords($localization['finance']), // 'Finance
            'icon' => 'bx bx-dollar',
            'children' => [
                ['title' => ucwords($localization['subscriptions']), 'link' => '/pages/reseller/subscriptions.php', 'icon' => 'bx bx-cart'],
                ['title' => ucwords($localization['invoices']), 'link' => '/pages/reseller/invoices.php', 'icon' => 'bx bx-receipt'],
                ['title' => ucwords($localization['payments']), 'link' => '/pages/reseller/payments.php', 'icon' => 'bx bx-credit-card'],
                ['title' => ucwords($localization['credits']), 'link' => '/pages/reseller/credits.php', 'icon' => 'bx bx-money'],
            ],
        ],
            [
                'title' => ucwords($localization['administration']), // 'Administration
                'icon' => 'bx bx-wrench',
                'children' => [
                    ['title' => ucwords($localization['users']), 'link' => '/pages/admin/reseller_users.php', 'icon' => 'bx bx-user'],
                    ['title' => ucwords($localization['API keys']), 'link' => '/pages/admin/reseller_api_keys.php', 'icon' => 'bx bx-key'],
                    ['title' => ucwords($localization['financial']), 'icon' => 'bx bx-dollar', 'children' => [
                        ['title' => ucwords($localization['taxes']), 'link' => '/pages/admin/reseller_taxes.php', 'icon' => 'bx bx-bank'],
                        ['title' => ucwords($localization['account types']), 'link' => '/pages/admin/reseller_account_types.php', 'icon' => 'bx bx-university']
                    ]],
                    ['title' => ucwords($localization['templates']), 'icon' => 'bx bx-file', 'children' => [
                        ['title' => ucwords($localization['subscription templates']), 'link' => '/pages/admin/reseller_subscription_templates.php', 'icon' => 'bx bx-file'],
                    ]],
                    ['title' => ucwords($localization['maintenance']), 'icon' => 'bx bx-cog', 'children' => [
                        ['title' => ucwords($localization['mail queue']), 'link' => '/pages/admin/reseller_mail_queue.php', 'icon' => 'bx bx-envelope'],
                        ['title' => ucwords($localization['audit logs']), 'link' => '/pages/admin/reseller_audit_logs.php', 'icon' => 'bx bx-history'],
                        ['title' => ucwords($localization['backup']), 'link' => '/pages/admin/reseller_backup.php', 'icon' => 'bx bx-cloud-download'],
                        ['title' => ucwords($localization['debug']), 'link' => '/pages/admin/reseller_debug.php', 'icon' => 'bx bx-bug']
                    ]]
                ]
            ],
            [
            'title' => ucwords($localization['settings']),
            'icon' => 'bx bx-cog',
            'children' => [
                ['title' => ucwords($localization['general']), 'icon' => 'bx bx-cog', 'children' => [
                    ['title' => ucwords($localization['company']), 'link' => '/pages/settings/settings_company.php', 'icon' => 'bx bx-building'],
                    ['title' => ucwords($localization['localization']), 'link' => '/pages/settings/settings_localization.php', 'icon' => 'bx bx-globe'],
                    ['title' => ucwords($localization['security']), 'link' => '/pages/settings/settings_security.php', 'icon' => 'bx bx-lock'],
                    ['title' => ucwords($localization['email']), 'link' => '/pages/settings/settings_email.php', 'icon' => 'bx bx-envelope'],
                    ['title' => ucwords($localization['webhooks']), 'link' => '/pages/settings/settings_webhooks.php', 'icon' => 'bx bx-link'],
                ]]
            ]
        ],
    ];
...
require_once "/var/www/nestogy.io/includes/shortcuts.php";
...
if (isset($client_page)) {
    $nav_title = $session_company_name . ": " . $client_name;
    $nav_title_link = '/pages/client/client_overview.php?client_id=' . $client_id;
} else {
    $nav_title = $session_company_name;
    $nav_title_link = '/pages/dashboard.php';
}

if (isset($session_multiple_companies)) {
    $nav_title_link = '/pages/company_select.php';
}
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/pages/user/user_details.php">
                                            ...
                                            <span class="align-middle"><?= ucwords($localization['profile']) ?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="/pages/user/user_preferences.php">
                                            <i class="bx bx-cog me-2"></i>
                                            <span class="align-middle"><?= ucwords($localization['settings']) ?></span>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="dropdown-divider"></div>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/post.php?logout" target="_blank">
                                            ...
                                            <span class="align-middle"><?= ucwords($localization['logout']) ?></span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <?php if (isset($client_page)) { //if page is client page (client.php, client-*.php
                        require_once "/var/www/nestogy.io/includes/inc_client_top_head.php";
                    }
                    ?>
