            ...
            <div class="row">
                ...
                <div class="col-md border-left border-top">
                    ...
                    <div class="ml-1 mt-1 text-secondary">Balance
                        <span class="<?php if ($balance > 0 || $balance < 0) { echo "text-danger"; }else{ echo "text-dark"; } ?> float-right"> <?= numfmt_format_currency($currency_format, $balance, $client_currency_code); ?></span>
                    </div>
                    ...
                    <div class="ml-1 mt-1 text-secondary">Net Terms
                        <span class="text-dark float-right"><?= $client_net_terms; ?><small class="text-secondary ml-1">Days</small></span>
                    </div>
                    <?php if(!empty($client_tax_id_number)) { ?>
                    <div class="ml-1 mt-1 text-secondary">Tax ID
                        <span class="text-dark float-right"><?= $client_tax_id_number; ?></span>
                    </div>
                    <?php } ?>
                </div>
                <?php } ?>
